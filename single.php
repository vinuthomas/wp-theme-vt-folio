...
<aside class="social-share-bar" aria-label="<?php esc_attr_e('Share this post', 'vt-folio'); ?>">
    <span class="social-share-bar__label" aria-hidden="true"><?php esc_html_e('Share', 'vt-folio'); ?></span>

    <a href="<?php echo esc_url('https://www.facebook.com/sharer/sharer.php?u=' . $share_url); ?>"
       target="_blank" rel="noopener noreferrer"
       class="social-share-bar__btn"
       aria-label="<?php esc_attr_e('Share on Facebook (opens in new tab)', 'vt-folio'); ?>">
    ...
    <a href="<?php echo esc_url('https://x.com/intent/post?url=' . $share_url . '&text=' . $share_title); ?>"
       target="_blank" rel="noopener noreferrer"
       class="social-share-bar__btn"
       aria-label="<?php esc_attr_e('Share on X (opens in new tab)', 'vt-folio'); ?>">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false" width="15" height="15">
    ...
    <a href="<?php echo esc_url('https://mastodon.social/share?text=' . $share_title . '%20' . $share_url); ?>"
       target="_blank" rel="noopener noreferrer"
       class="social-share-bar__btn"
       aria-label="<?php esc_attr_e('Share on Mastodon (opens in new tab)', 'vt-folio'); ?>">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false" width="15" height="15">
    ...
    <a href="<?php echo esc_url('https://www.linkedin.com/shareArticle?mini=true&url=' . $share_url); ?>"
       target="_blank" rel="noopener noreferrer"
       class="social-share-bar__btn"
       aria-label="<?php esc_attr_e('Share on LinkedIn (opens in new tab)', 'vt-folio'); ?>">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false" width="15" height="15">
...
<article id="post-<?php the_ID(); ?>" <?php post_class('single-post'); ?>>
    ...
    <nav class="post-navigation" aria-label="<?php esc_attr_e('Post navigation', 'vt-folio'); ?>">
        <?php
        ...
        <div class="post-nav-item post-nav-item--prev">
            <span class="post-nav-label" aria-hidden="true">&larr; <?php esc_html_e('Previous', 'vt-folio'); ?></span>
            <a href="<?php echo esc_url(get_permalink($prev)); ?>" class="post-nav-title"
               aria-label="<?php echo esc_attr( sprintf( __('Previous post: %s', 'vt-folio'), get_the_title($prev) ) ); ?>">
        ...
        <div class="post-nav-item post-nav-item--next">
            <span class="post-nav-label" aria-hidden="true"><?php esc_html_e('Next', 'vt-folio'); ?> &rarr;</span>
            <a href="<?php echo esc_url(get_permalink($next)); ?>" class="post-nav-title"
               aria-label="<?php echo esc_attr( sprintf( __('Next post: %s', 'vt-folio'), get_the_title($next) ) ); ?>">
...
<aside class="single-sidebar" aria-label="<?php esc_attr_e('Post sidebar', 'vt-folio'); ?>" role="complementary">
